...
import { Send, Sparkles, Command, Loader2, CheckCircle2, Circle, Terminal, Compass, Info, X, ThumbsUp, AlertTriangle, Ban } from 'lucide-react';
...
export const AiCopilotSidebar = ({
        ...
        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
          ...
          <div className="space-y-1.5">
            {recentRuns.map((run) => {
              ...
              return (
                <div key={run.id} className="rounded-md bg-white border border-slate-100 px-3 py-3">
                  <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="mt-2 grid grid-cols-1 gap-1.5 text-[11px] text-slate-500 leading-relaxed">
  ...
  return (
    <div className="w-[500px] bg-white border-l border-slate-200 h-full shrink-0 flex flex-col relative z-20 shadow-[-4px_0_24px_rgba(0,0,0,0.02)]">
